...
Or are you frustrated by the lack of a quick way to look up and save those beautiful words?!

Stick around — this app offers an elegant solution!
...
Kotlin + Jetpack Compose · Room Database · Retrofit · DataStore Preferences



## Build

Open the project in Android Studio, sync Gradle, and run. Minimum Android 10 (API 29) required.